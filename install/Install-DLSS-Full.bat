...
$Self=$env:GTAIV_SETUP_SELF;$Repo='JungleHam/GTAIV-DLAA-DLSS4.5-DLSS5';$RuntimeTag='v1.0.0'
...
try{
 ...
 Write-Host '';Write-Host 'DONE - DLSS Full + Neural Rendering installed.' -ForegroundColor Green;Start-Sleep -Seconds 3;exit 0
