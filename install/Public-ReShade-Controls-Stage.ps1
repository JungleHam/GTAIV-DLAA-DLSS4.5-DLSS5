...
# Replace that exact frozen block, including its trailing separator, with the public
# five-mode selector. The engineering-only DLAA presenter baseline remains available
# internally but is intentionally not exposed in the public dropdown.
$qualityOld = @'
